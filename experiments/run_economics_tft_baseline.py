"""Economics-domain TFT-style baseline runner.

Thin wrapper around :mod:`experiments.run_economics_lstm_baseline` that swaps
the model class to :class:`TFTBaseline` while reusing the loader, temporal
...
from experiments import run_economics_lstm_baseline as lstm_runner
