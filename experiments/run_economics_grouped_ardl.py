"""Run the grouped ARDL-style baseline on the economics panel."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Run grouped ARDL economics baseline.")
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/step5/economics_grouped_ardl")
    parser.add_argument("--experiment-name", type=str, default="E4_economics_grouped_ardl")
...
def main() -> None:
    ...
    print(
        "Economics grouped ARDL complete. "
